...
export class EventServiceProxy {
     ...
     * @return Success
     */
    getListAsync(includeCancelledEvents: boolean): Observable<ListResultDtoOfEventListDto> {
...
<<<<<<< HEAD
     ...
     * @return Success
     */
    uploadFiles(file: any): Observable<void> {
...
export class PostServiceProxy {
     ...
     * @return Success
     */
    getPostListAsync(): Observable<ListResultDtoOfPostListDto> {
        let url_ = this.baseUrl + "/api/services/app/Post/GetPostListAsync";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            return this.processGetPostListAsync(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetPostListAsync(<any>response_);
                } catch (e) {
    ...
    protected processGetPostListAsync(response: Response): Observable<ListResultDtoOfPostListDto> {
        const status = response.status;
     ...
     * @return Success
     */
    getPostDetailAsync(id: string): Observable<PostDetailOutput> {
        let url_ = this.baseUrl + "/api/services/app/Post/GetPostDetailAsync?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            return this.processGetPostDetailAsync(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetPostDetailAsync(<any>response_);
                } catch (e) {
                    return <Observable<PostDetailOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<PostDetailOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetPostDetailAsync(response: Response): Observable<PostDetailOutput> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PostDetailOutput.fromJS(resultData200) : new PostDetailOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PostDetailOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createPostAsync(input: CreatePostInput): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Post/CreatePostAsync";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            return this.processCreatePostAsync(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processCreatePostAsync(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>Observable.throw(e);
                }
            } else
    ...
    protected processCreatePostAsync(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    createCommentAsync(input: CreateCommentInput): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Post/CreateCommentAsync";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            return this.processCreateCommentAsync(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processCreateCommentAsync(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>Observable.throw(e);
                }
            } else
    ...
    protected processCreateCommentAsync(response: Response): Observable<void> {
        const status = response.status;
...
export class PostDetailOutput implements IPostDetailOutput {
    title: string;
    authorName: string;
    summary: string;
    tags: string;
    ...
    constructor(data?: IPostDetailOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PostDetailOutput {
        data = typeof data === 'object' ? data : {};
        let result = new PostDetailOutput();
        result.init(data);
        return result;
    }
...
export interface IPostDetailOutput {
    title: string;
    authorName: string;
    summary: string;
    tags: string;
