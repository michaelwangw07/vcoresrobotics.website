...
using vcoresrobotics.website.Domain.Events;
...
namespace vcoresrobotics.website.Events
{
    ...
    public class Event : FullAuditedEntity<Guid>, IMustHaveTenant
    {
        ...
        {
            return Date.Subtract(Clock.Now).TotalHours <= 2.0;// 2 hours can be defined as Event property and datermined per event.
        }
